    <template>
      ...
      <!--   <div class="medium-6 medium-offset-3 ctrl">
        ...
        <div class="table">
          ...
          <div class="medium-6 medium-offset-3 ctrl">
            <form class="searchForm" v-on:submit.prevent="submitSearch">
              <input type="text" placeholder="search active drivers..." style="text-align:center; margin-bottom:30px">
            </form>
          </div>
          ...
          <div class="column">
            ...
            <div class="medium-6 medium-offset-3 ctrl">
            <form class="searchForm" v-on:submit.prevent="submitSearch">
              <input type="text" placeholder="search active routes..." style="text-align:center; margin-bottom:30px">
            </form>
          </div>
            <span>source</span>
            <span>---></span>
